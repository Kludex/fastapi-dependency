...
@pytest.mark.parametrize("run_in_threadpool", [True, False])
...
def test_thread_depends() -> None:
    ...
    @app.get("/")
    def root(depends: str = ThreadDepends(dependency)) -> Any:
        return {"depends": depends}
...
def test_threadless_depends() -> None:
    ...
    @app.get("/")
    def root(depends: str = ThreadlessDepends(dependency)) -> Any:
        return {"depends": depends}
...
def test_security_with_run_in_threadpool() -> None:
    ...
    @app.get("/")
    def root(depends: str = Security(dependency, run_in_threadpool=True)) -> Any:
        return {"depends": depends}
...
def test_thread_security() -> None:
    ...
    @app.get("/")
    def root(depends: str = ThreadSecurity(dependency)) -> Any:
        return {"depends": depends}
...
def test_threadless_security() -> None:
    ...
    @app.get("/")
    def root(depends: str = ThreadlessSecurity(dependency)) -> Any:
        return {"depends": "test"}
